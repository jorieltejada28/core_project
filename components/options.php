<div class="bg-gray-900 p-4 rounded-md flex items-center">
    <!-- Hamburger Menu -->
    ...
    <!-- Icons -->
    <button class="text-white text-2xl mx-2"><i class="fas fa-envelope"></i></button>
    <button class="text-white text-2xl mx-2"><i class="fas fa-bell"></i></button>
</div>